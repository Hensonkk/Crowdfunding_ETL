...
1. Create the Category and Subcategory DataFrames
    - Extract and transform the 'crowdfunding.xlsx' Excel data to create a category DataFrame that has the following columns:
        ...
        - Export the category DataFrame as 'category.csv' (Located in our *[Exported CSVs](Resources)* folder)
    - Extract and transform the 'crowdfunding.xlsx' Excel data to create a subcategory DataFrame that has the following columns:
        ...
        - Export the subcategory DataFrame as 'subcategory.csv' (Located in our *[Exported CSVs](Resources)* folder)
1. Create the Campaign DataFrame
    - Extract and transform the 'crowdfunding.xlsx' Excel data to create a campaign DataFrame has the following columns:
        ...
        - Export the campaign DataFrame as 'campaign.csv' (Located in our *[Exported CSVs](Resources)* folder)
1. Create the Contacts DataFrame
    - Use Python dictionary methods to extract and transform the data from the 'contacts.xlsx' Excel data:
        ...
        - Iterate through each dictionary, doing the following:
            ...
            - Clean and export the DataFrame as 'contacts.csv' (Located in our *[Exported CSVs](Resources)* folder)
